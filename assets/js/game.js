...
var fight = function (enemyName) {
    while (playerHealth > 0 && enemyHealth > 0) {
        ...
        if (promptFight === "fight" || promptFight === "FIGHT") {
            ...
            playerHealth = Match.max(0, playerHealth - damage);
            console.log(
...
var startGame = function () {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            // pass the pickedEnemyName variable's value into the fight function, where it will assume the value of the enemyName paramete
    ...
    switch (shopOptionPrompt) {
        ...
        case "REFILL":
            if (playerMoney >= 7) {
                ...
                // Increase health and deacrease money 
